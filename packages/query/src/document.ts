 ...
 */
import { tag, type Tag, type TagVars } from './tags.js';
// Type-only, so the build-time loader still pulls in nothing but this file.
import type { Variables } from './client.js';
 ...
 * type argument at the call site, once `@firsthandjs/query/codegen` has written
 ...
 *
 * Malformed directives throw. With the `@firsthandjs/query/vite` loader that

/**
 * The shapes a view can be written in, and which of them compile.
 *
 * A view is a reactive scope (ADR-0026): a setup may hand back a render
 * function, and that function runs again as a whole. These are the cases that

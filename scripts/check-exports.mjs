...
const expectations = [
  ...
  { pkg: 'data-axios', entry: '.', names: ['createAxiosClient'] },
  { pkg: 'data-urql', entry: '.', names: ['createUrqlClient'] },
  { pkg: 'data-apollo', entry: '.', names: ['createApolloClient'] },
  { pkg: 'data', entry: './vite', names: ['graphql', 'inlineImports'] },
  { pkg: 'data', entry: './codegen', names: ['plugin'] },
  {
    pkg: 'styled',
    entry: '.',

...
| R6  | 6 kB gzip target unreachable with the full feature set                                | A headline goal is missed                                | `npm run build`             | **closed**: 5.86 kB gzip with everything imported; the build fails above 6 kB. Routing and the query cache are separate packages, outside that budget.                                                                                                                               |
